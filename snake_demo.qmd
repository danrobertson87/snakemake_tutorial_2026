...
This assumes you have conda/pixi installed already (it is possible to install with conda alone).
...
Please see link below, this will give the correct commands for your system;
[Instructions for setting up tutorial](https://snakemake.readthedocs.io/en/stable/tutorial/setup.html)

Here I've set up my mac with;
...
You can view the full tea Snakefile [here](https://github.com/danrobertson87/snakemake_tutorial_2026/blob/main/go_on/Snakefile).

``` bash
mkdir go_on
cd go_on
# download Snakefile or copy/paste from above link
nano Snakefile
